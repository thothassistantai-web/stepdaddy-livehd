                ...
                rx.center(
                    rx.box(
                        rx.hstack(
                            ...
                            rx.cond(
                                channel.dead,
                                rx.badge("dead", color_scheme="red", variant="solid"),
                            ),
                            rx.cond(
                                channel.tvg_id,
                                rx.cond(
                                    channel.epg_has_data,
                                    rx.badge("epg live", color_scheme="green", variant="soft"),
                                    rx.badge("epg mapped", color_scheme="amber", variant="soft"),
                                ),
                                rx.badge("no epg", color_scheme="gray", variant="soft"),
                            ),
                            justify="center",
                            align="center",
                            width="100%",
