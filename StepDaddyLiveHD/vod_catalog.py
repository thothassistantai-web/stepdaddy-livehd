...
TMDB is not called. Stream aggregators still receive numeric `tmdb_id` values
when Cinemeta provides `moviedb_id` on a title.
"""
...
UA = "Mozilla/5.0 (X11; Linux x86_64) StepDaddy-Gateway/1.0"
PAGE_SIZE = 50
...
class VodCatalogService:
    ...
    def home(self) -> dict:
        ...
        sections = [
            {"id": "trending_movies", "title": "Popular Movies", "items": movies},
            {"id": "trending_tv", "title": "Popular TV", "items": tv},
            {"id": "featured_movies", "title": "Top Rated Movies", "items": featured_m},
            {"id": "featured_tv", "title": "Top Rated TV", "items": featured_t},
            {"id": "new_movies", "title": "New Movies", "items": new_m},
            {"id": "popular_movies", "title": "More Movies", "items": pop_m},
            {"id": "popular_tv", "title": "More TV", "items": pop_t},
        ]
        return {
